...
class BreadcrumbsAttributesThrowsOnChildControllerOverrideTest extends TestCase
{
    public function setUp(): void
    {
        parent::setUp();

        Config::set('erickcomp-laravel-breadcrumbs-attributes.when_already_defined', ConfigWhenAlreadyDefined::ThrowException);
    }

    /** @test */
    public function it_cannot_override_a_base_controller_breadcrumb()
    {
        $this->registerRoutes();
        $this->expectExceptionMessageMatches('/^The breadcrumb named \"base\-and\-overrides\-controllers\" cannot be redefined/');
